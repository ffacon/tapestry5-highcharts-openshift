 ...
 */
package dev.openshift.tapestry.highcharts.pages;
...
import dev.openshift.tapestry.highcharts.pages.Index;
...
public class TestIndex extends Assert {
	...
	public final void test() {
		String appPackage = "dev.openshift.tapestry.highcharts";
		String appName = "App";
